...
int luzGaragem = 22;                    // Usa o pino digital 22 para a luz da Garagem
int luzSala = 23;                       // Usa o pino digital 23 para a luz da Sala
...
void setup()
{
  ...
  servoGaragem.write(122);                    // Inicia com o portao fechado (122º)
...
void loop()
{
  ...
  if (estadoServo == 0) {
    servoGaragem.write(122);       			      // Movimenta o Servo para 122 graus
  }
  if (estadoServo == 1) {
    servoGaragem.write(25);       			      // Movimenta o Servo para 25 graus
  }
